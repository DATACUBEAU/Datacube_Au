...
exports.USAGE_METRIC_ALIASES = exports.TRACKED_USAGE_METRIC_KEYS = exports.USAGE_TRACKING_HEADER = void 0;
exports.flattenUsageText = flattenUsageText;
exports.estimateTokenCountFromText = estimateTokenCountFromText;
exports.estimateChatRequestTokens = estimateChatRequestTokens;
exports.normalizeMetricIncrements = normalizeMetricIncrements;
exports.buildChatUsageIncrements = buildChatUsageIncrements;
exports.buildFeatureUsageIncrements = buildFeatureUsageIncrements;
exports.buildUploadUsageIncrements = buildUploadUsageIncrements;
exports.readUsageMetricValue = readUsageMetricValue;
exports.USAGE_TRACKING_HEADER = 'x-au-usage-tracked';
exports.TRACKED_USAGE_METRIC_KEYS = [
    'max_chats_total',
    'used_chats',
    'messages_count',
    'max_tokens_total',
...
function flattenUsageText(value) {
    if (typeof value === 'string')
        return value.trim();
    if (Array.isArray(value))
        return value.map((entry) => flattenUsageText(entry)).filter(Boolean).join('\n');
...
function estimateTokenCountFromText(...parts) {
...
function estimateChatRequestTokens(input) {
...
function normalizeMetricIncrements(input) {
...
function buildChatUsageIncrements(estimatedTokens) {
...
function buildFeatureUsageIncrements(feature) {
...
function buildUploadUsageIncrements(fileSizeBytes) {
...
function readUsageMetricValue(source, aliases, fallback = 0) {
