...
export function FeedbackSection({ sectionName }: FeedbackSectionProps) {
  ...
  const handleSubmit = (selectedReason?: string) => {
    ...
    console.log(`[Feedback] Section: ${sectionName}, Type: ${feedbackType}, Reason: ${finalReason}`);
              ...
              {!isOther ? (
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-end gap-2">
                    <Button variant="ghost" size="sm" className="h-7 text-[10px]" onClick={() => setIsOther(false)}>Back</Button>
                    <Button size="sm" className="h-7 text-[10px]" onClick={() => handleSubmit()}>Submit</Button>
                  </div>
                </div>
              )}
            </div>
