...
import { GLOBAL_CHAT_TITLE } from '@shared/global-chat-routing';
      ...
      <DialogContent className="sm:max-w-[500px] border-primary/20 bg-background/95 backdrop-blur-md">
        <DialogHeader className="space-y-4">
          ...
          <DialogDescription className="text-center text-base pt-2 text-foreground/80 leading-relaxed">
            Global Chat is currently unavailable. It handles app-wide help and navigation, not private document retrieval.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          <div className="rounded-xl border border-primary/10 bg-primary/5 p-4 space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-1">
                <h4 className="font-bold text-sm text-primary uppercase tracking-tight">What Is Global Chat?</h4>
                <p className="text-sm text-muted-foreground leading-snug">
                  Use AU Chat for document-grounded answers. Use Global Chat for app navigation, general explanations, and study-flow help.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 p-4 rounded-xl border border-dashed border-muted-foreground/20 bg-muted/5">
            ...
            <div className="space-y-1">
              <h4 className="font-bold text-sm text-foreground/80 uppercase tracking-tight">Need Help?</h4>
              <p className="text-xs text-muted-foreground">
                Contact support if this page should be enabled for your account.
              </p>
            </div>
          </div>
        </div>
