...
const features = [
  ...
  },
  {
    ...
    description:
      'Access cached data, read materials, and queue questions even without an internet connection.',
    icon: WifiOff,
  },
  {
  ...
  },
  {
    ...
    description:
      'Distills long documents into concise summaries and extracts crucial key points for quick review.',
    icon: BookCopy,
  },
  {
    title: 'Installable App (PWA)',
    description:
      'Install DataCube AU on your desktop, Android, or iOS device for a native, offline-first experience.',
    icon: Cpu,
  },
  {
      ...
      <div className="relative mx-auto max-w-5xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            DataCube AU is built on a powerful foundation of interconnected AU features designed to
          ...
          <div className="space-y-16">
            {features.map((feature, index) => {
              ...
              return (
                <div
                  key={feature.title}
                  className={`group relative flex items-center md:justify-start ${isLeft ? '' : 'md:justify-end'}`}
                >
                  ...
                  <div className="absolute top-1/2 -translate-y-1/2 h-4 w-4 rounded-full bg-primary ring-4 ring-background left-6 -translate-x-1/2 md:left-1/2 md:-translate-x-1/2" />
                  <div
