...
-- 20260305120000_chat_rag_observability_upgrade.sql
...
BEGIN
  IF EXISTS (
    ...
    UPDATE public.au_model_usage SET model_id = model WHERE (model_id IS NULL OR model_id = '') AND model IS NOT NULL;
  END IF;
END;
$$;
