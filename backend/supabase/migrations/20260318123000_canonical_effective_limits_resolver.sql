...
INSERT INTO public.au_plan_limit_rules (
  scope,
  limit_key,
  value,
  mode,
...
VALUES
  ('default', 'max_chats_total', 3000, 'usage', 'daily', NULL, NULL, TRUE, FALSE),
  ('default', 'max_uploads_total', 50, 'current', 'never', NULL, NULL, TRUE, FALSE),
  ('default', 'max_tokens_total', 4000, 'usage', 'daily', NULL, NULL, TRUE, FALSE),
  ('default', 'max_file_size_mb', 50, 'per_request', 'never', NULL, NULL, TRUE, FALSE),
  ('default', 'max_concurrent_jobs', 1, 'concurrency', 'never', NULL, NULL, TRUE, FALSE),
  ('default', 'max_exam_predictions', 10, 'usage', 'never', NULL, NULL, TRUE, FALSE),
  ('default', 'max_practice_exams', 10, 'usage', 'never', NULL, NULL, TRUE, FALSE),
  ('default', 'max_knowledge_hub', 50, 'current', 'never', NULL, NULL, TRUE, FALSE),
  ('pro', 'max_chats_total', 30000, 'usage', 'daily', NULL, NULL, TRUE, FALSE),
  ('pro', 'max_uploads_total', 500, 'current', 'never', NULL, NULL, TRUE, FALSE),
  ('pro', 'max_tokens_total', 18000, 'usage', 'daily', NULL, NULL, TRUE, FALSE),
  ('pro', 'max_concurrent_jobs', 3, 'concurrency', 'never', NULL, NULL, TRUE, FALSE),
  ('pro', 'max_exam_predictions', 200, 'usage', 'never', NULL, NULL, TRUE, FALSE),
  ('pro', 'max_practice_exams', 200, 'usage', 'never', NULL, NULL, TRUE, FALSE),
  ('pro', 'max_knowledge_hub', 500, 'current', 'never', NULL, NULL, TRUE, FALSE),
  ('premium', 'max_chats_total', 100000, 'usage', 'daily', NULL, NULL, TRUE, FALSE),
  ('premium', 'max_uploads_total', 1500, 'current', 'never', NULL, NULL, TRUE, FALSE),
  ('premium', 'max_tokens_total', 45000, 'usage', 'daily', NULL, NULL, TRUE, FALSE),
  ('premium', 'max_concurrent_jobs', 6, 'concurrency', 'never', NULL, NULL, TRUE, FALSE),
  ('premium', 'max_exam_predictions', 1000, 'usage', 'never', NULL, NULL, TRUE, FALSE),
  ('premium', 'max_practice_exams', 1000, 'usage', 'never', NULL, NULL, TRUE, FALSE),
  ('premium', 'max_knowledge_hub', 1500, 'current', 'never', NULL, NULL, TRUE, FALSE)
ON CONFLICT (scope, limit_key) DO NOTHING;
...
BEGIN
  ...
  ELSIF v_profile_tier IN ('pro', 'promo_pro', 'weekly', 'monthly', 'paid') THEN
    v_profile_plan := 'pro';
  ...
  IF v_mirrored_plan IN ('promo_pro', 'pro', 'weekly', 'monthly', 'paid', 'admin') THEN
    v_mirrored_plan := 'pro';
  ...
  ELSIF v_has_pro THEN
    ...
    v_entitlement_source := CASE
      WHEN LOWER(COALESCE(v_entitlements->>'entitlement_source', '')) IN ('paid', 'promo')
        THEN LOWER(v_entitlements->>'entitlement_source')
      ELSE 'paid'
    END;
